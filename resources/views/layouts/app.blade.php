        ...
        @else
            <aside class="main-sidebar sidebar-dark-primary elevation-4 position-fixed" style="background-color: #417D7A">
                ...
                <a href="#" class="brand-link" style="text-decoration: none">
                    <div class="row">
                        <div class="col-md-4">
                            <img src="{{ asset('storage/img/logoBNA.png') }}" width="80" alt="">
                        </div>
                        <div class="col-md-7">
                    ...
                    <nav class="mt-2">
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            @if (auth()->user()->level == 'admin')
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse  {{ in_array(request()->route()->getName(),['maps lokasi', 'maps desa', 'maps', 'Rute'])? 'show': '' }}"
                                        ...
                                        <ul class="nav ms-4 ps-3">
                                            ...
                                            <li class="nav-item w-100 ">
                                                <a class="item {{ request()->route()->getName() == 'Rute'? 'text-white active': '' }}"
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse  {{ in_array(request()->route()->getName(),['halaman data', 'halaman data2', 'halaman desa', 'halaman tematik', 'rumah sakit'])? 'show': '' }}"
                                        ...
                                        <ul class="nav ms-4 ps-3">
                                            <li class="nav-item w-100">
                                                <a class="item {{ request()->route()->getName() == 'halaman data'? 'text-white active': '' }}"
                                            ...
                                            <li class="nav-item w-100">
                                                <a class="item {{ request()->route()->getName() == 'halaman desa'? 'text-white active': '' }}"
                                            ...
                                            <li class="nav-item w-100 ">
                                                <a class="item {{ request()->route()->getName() == 'rumah sakit'? 'text-white active': '' }}"
                            ...
                            @else
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('verif') }}"
                                        class="nav-link btn {{ request()->route()->getName() == 'verif'? 'text-white active': '' }}  text-white text-start">
                                        <i class="nav-icon fas fa-th"></i>
                                        <p>
                                            Verifikasi
                                        </p>
