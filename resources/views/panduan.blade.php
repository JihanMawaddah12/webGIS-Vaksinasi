        ...
        <div class="container">
            <div class="card p-4">
                ...
                <div class="mt-2">
                    ...
                    <div class="text-center"><img class="mx-auto" width="700" src="{{ asset('storage/img/daftar.png') }}" alt="">
                    </div>
                </div>
                ...
                <div class="mt-2">
                    ...
                    <div class="text-center"><img class="mx-auto" width="700" src="{{ asset('storage/img/IsiData.png') }}" alt="">
                    </div>
        ...
        <div class="mt-3 container">
            <div class="card p-4">
                ...
                <div class="mt-2">
                    ...
                    <div class="text-center"><img class="mx-auto" width="700" src="{{ asset('storage/img/LoginRS.png') }}" alt="">
                    </div>
                </div>
                ...
                <div class="mt-2">
                    ...
                    <div class="text-center"><img class="mx-auto" width="700" src="{{ asset('storage/img/DataDaftar.png') }}"
                            alt=""></div>
                </div>
                ...
                <div class="mt-2">
                    ...
                    <div class="text-center"><img class="mx-auto" width="700" src="{{ asset('storage/img/verifikasi.png') }}"
                            alt=""></div>
        ...
        <div class="mt-3 container">
            <div class="card p-4">
                ...
                <div class="mt-2">
                    ...
                    <div class="text-center"><img class="mx-auto" width="700" src="{{ asset('storage/img/loginAdmin.png') }}"
                            alt=""></div>
                ...
                <div class="mt-2">
                    ...
                    <div class="text-center"><img class="mx-auto" width="700" src="{{ asset('storage/img/dashboard.png') }}"
                            alt=""></div>
                ...
                <div class="mt-2">
                    ...
                    <div class="text-center"><img class="mx-auto" width="700" src="{{ asset('storage/img/lokasi.png') }}" alt="">
                    </div>
                </div>
                ...
                <div class="mt-2">
                    ...
                    <div class="text-center"><img class="mx-auto" width="700" src="{{ asset('storage/img/data.png') }}" alt="">
                    </div>
